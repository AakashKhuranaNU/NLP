...
def get_awards(year):
    ...
    of this function or what it returns.'''
    awards = gg_apifake.get_awards(year)
    return awards
...
def get_nominees(year):
    ...
    global OFFICIAL_AWARDS
    fres = get_answers(year)
    nominees = {award: fres[award]['Nominees'] for award in OFFICIAL_AWARDS}
    print(nominees)
    return nominees
...
def get_winner(year):
    ...
    global OFFICIAL_AWARDS
    fres = get_answers(year)
    winners = {award: fres[award]['Winner'] for award in OFFICIAL_AWARDS}
    return winners
...
def get_presenters(year):
    ...
    global OFFICIAL_AWARDS
    fres = get_answers(year)
    presenters = {award: fres[award]['Presenters'] for award in OFFICIAL_AWARDS}
    return presenters
